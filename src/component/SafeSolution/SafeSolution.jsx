 ...
 <div className="grid gap-6 lg:grid-cols-3 xl:gap-x-12">
   <div className="mb-6 lg:mb-0">
     <div className="relative block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
       <div className="flex">
         ...
         >
           <img
             src="http://cbsnews1.cbsistatic.com/hub/i/2015/04/01/2667ab91-4e49-482c-9301-d5e45ea224b9/istock000045773978large.jpg"
             className="w-full"
           />
           <a href="#!">
       ...
       <div className="p-6">
         <h5 className="mb-3 text-lg font-bold">Phần mềm quản lý <br/>bán hàng coffee phổ biến nhất</h5>
        
         <p className="mb-4 pb-2 text-left ">
           Đơn giản quản lý hàng hóa , nhân sự  
         </p>
         <p className="mb-4 pb-2 text-left">
         Dễ dàng  báo cáo ,theo dõi tăng trưởng doanh thu
         </p>
         <p className="mb-4 pb-2 text-left">
   ...
   <div className="mb-6 lg:mb-0">
     <div className="relative block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
       ...
       <div className="p-6">
         <h5 className="mb-3 text-lg font-bold">Sàn kết nối nguồn hàng giá tốt<br/> dành cho nhà bán hàng</h5>
         
         <p className="mb-4 pb-2 text-left">
           Nhà bán hàng tìm kiếm nguồn hàng với hơn 1000 nhà cung cấp và nhãn hàng tuy tín trên thị trường
         </p>
         <p className="mb-4 pb-2 text-left ">
           Nhà cung cấp tìm kiếm đại lý phân phối dễ dàng với chi phí hiệu quả
         </p>
         <a
           href="#!"
           data-te-ripple-init=""
   ...
   <div className="mb-0">
     <div className="relative block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
       <div className="flex">
         ...
         >
           <img
             src="https://www.agiboo.com/wp-content/uploads/2017/12/coffee-beans-steaming-cup-scaled.jpg"
             className="w-full"
           />
           <a href="#!">
             <div className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100 bg-[hsla(0,0%,98.4%,.15)]"></div>
       ...
       <div className="p-6">
         <h5 className="mb-3 text-lg font-bold">Giải pháp thanh toán - vay vốn <br/>uy tín dành cho chủ shop</h5>
         
         <p className="mb-4 pb-2 text-left">
           Tích hợp thanh toán QR cùng với rất nhiều  tiện ích khả dụng khác mà bạn không nên bỏ qua
         </p>
         <p className="mb-4 pb-2 text-left">
